...
import css from '../images/skills/visual-studio-code-icon.png'
...
export default function Skill({directionLeft}: Props) {
  return (
    <div className='group relative flex cursor-pointer'>
        ...
        >
            <Image className='rounded-full w-20  h-20 md:w-23 md:h-23 xl:w-26 xl:h-26 object-contain' src={css} alt=''/>
        </motion.div>
        {/* <motion.img
        initial={{
            x: directionLeft? -200:200,
